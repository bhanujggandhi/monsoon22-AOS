...
void client_function(const char* request, int CLIENTPORT) {
    ...
    if (reqarr[0] == "create_user") {
        ...
        if (buffer[0] == 'S') {
            ...
            // vector<pair<int, pair<string, pair<string, vector<string>>>>>
            //     pieceselection;
            ...
            // for (int i = 0; i < pieceselection.size(); i++) {
            //     pthread_create(&threads[i], NULL, downloadexec,
            //                    (void*)pieceselection[i]);
            // }
            ...
            // for (int i = 0; i < pieceselection.size(); i++) {
            //     downloadexec((void*)pieceselection[i]);
            // }
